                                ...
                                <td class="px-6 py-3">
                                    @if($paiement->commande && in_array($paiement->commande->statut, ['prete', 'payee']))
                                        <div class="flex space-x-2">
                                            ...
                                            <!-- Bouton Ouvrir -->
                                            <a href="{{ route('commandes.ouvrirFacture', $paiement->commande_id) }}"
                                               target="_blank"
                                               class="inline-flex items-center space-x-1.5 bg-red-600 hover:bg-red-600 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition">
                                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
